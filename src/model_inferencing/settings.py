...
GLINER_MODEL = r"D:\Raghu Studies\omdena\CameroonFranceChapter_LegalComplianceAssistant\src\model_inferencing\gliner_inference_model" # self finetuned model
THRESHOLD = 0.75
FONT_NAME = "Helvetica"

# YOLO Path
PYTHON_EXEC = "D:/Raghu Studies/omdena/CameroonFranceChapter_LegalComplianceAssistant/.src_omdena_legal/Scripts/python.exe"
YOLO_DETECT_PATH = r"D:/Raghu Studies/omdena/CameroonFranceChapter_LegalComplianceAssistant/src/model_inferencing/yolov5/detect.py"
YOLO_WEIGHTS = r"D:/Raghu Studies/omdena/CameroonFranceChapter_LegalComplianceAssistant/src/model_inferencing/yolov5/runs/train/exp/weights/best.pt"
